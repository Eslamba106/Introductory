...
{{ $data->withQueryString()->appends(['search' => 1])->links() }}
@endsection
<!-- row opened -->
        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="col-sm-1 col-md-2">
                    @can('اضافة مستخدم')
                        <a class="btn btn-primary btn-sm" href="{{ route('moderators.create') }}">اضافة مستخدم</a>
                    @endcan
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($data as $key => $user)
                                <tr>
                                    ...
                                    <td>
                                        @can('تعديل مستخدم')
                                            <a href="{{ route('moderators.edit', $user->id) }}" class="btn btn-sm btn-info"
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('moderator.destroy', 'test') }}" method="post">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
