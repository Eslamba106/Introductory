            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="{{ route('user.blog_artical.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="{{ route('user.blog_artical.delete') }}" method="post">
                            @method('delete')
                            @csrf
        ...
        <tbody>
            ...
            @forelse ($articals as $item)
                <tr>
                    ...
                    @can('edit')
                        <td>
                            <a href="{{ route('user.blog_artical.edit', $item->id) }}"
                                class="btn btn-sm btn-outline-success">{{ __('admin/blog.edit_artical') }}</a>
                        </td>
                    @endcan

                    <td>
                        <a href="{{ route('user.blog_artical.show', $item->id) }}"
                            class="btn btn-sm btn-outline-info">{{ __('admin/blog.show') }}</a>
                    </td>
                    @can('delete')
                        <td>
