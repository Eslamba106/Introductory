                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 text-center">
                            <div class="">
                                <p class="mb-3 content-1 h5 text-white">{{ __('admin/settings.knowledge') }} <span
                                        class="tx-info-dark"></span></p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-8">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="position-relative">
                                            <a href="#">
                                                <img class="card-img-top" src="{{ $item->imageUrl }}" alt="img"
                                                    width="100">
                                            </a>
                                        </div>
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center pt-4 mt-auto">
                                                ...
                                                <div>
                                                    ...
                                                    <small
                                                        class="d-block tx-muted">{{ $item->created_at->shortAbsoluteDiffForHumans() }}</small>
                                                </div>
                                                <div class="ms-auto">
                        ...
                        <!-- COL-END -->
                        {{ $knowledge_center->withQueryString()->appends(['search' => 1])->links() }}
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="">
                                    <p class="h5 mb-4">{{ __('admin/knowledge.departments') }}</p>
                                    @forelse ($categories as $item)
                                        <div class="row mb-3 mb-xl-0">
                                            <div class="col-xl-4 col-lg-2 col-md-3 col-sm-4 text-center">
                                                {{-- <img src="{{ $item->imageUrl }}" class="img-fluid br-5 w-100" width="120"
                                                    alt="img"> --}}
                                            </div>
                                            <div class="col-xl-8 col-lg-9 col-md-8 col-sm-8">
                                                {{-- <span class="badge bg-danger-transparent tx-danger me-1 mb-1 mt-3 mt-sm-0">
