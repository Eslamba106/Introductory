        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('admin.news_ads.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('admin.news_ads.delete') }}" method="post">
                        @method('delete')
                        @csrf
        ...
        <tbody>
            ...
            @forelse ($news as $item)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.news_ads.edit' , $item->id) }}" class="btn btn-sm btn-outline-success">{{ __('admin/news_ads.edit') }}</a>
                    </td>
                    {{-- <td>
                    ...
                    <td>
                        <a href="{{ route('admin.news_ads.show' , $item->id) }}" class="btn btn-sm btn-outline-info">{{ __('admin/news_ads.show') }}</a>
                    </td>
                    <td>
