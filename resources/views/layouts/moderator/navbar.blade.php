<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('logout.moderator') }}" class="nav-link">{{ __('main.logout') }}</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <a class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown" href="#">
            {{-- <i class="far fa-bell"></i> --}}
            <span class="badge badge-success navbar-badge">{{ __('admin/general.lang') }}
            </span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <span class="dropdown-header">{{ __('admin/general.lang') }}</span>
